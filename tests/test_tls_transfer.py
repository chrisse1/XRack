...
#
from _wurzel import WURZEL as PROJEKT  # noqa: F401,E402
...
#
# ACHTUNG, zwei Wurzeln: "WURZEL" ist hier das ARBEITSVERZEICHNIS des
# Versuchs (zwei nachgestellte Racks darin), die Projektwurzel heisst
# PROJEKT. Beim Umzug der Tests in tests/ ist genau das einmal
# durcheinandergeraten - install.sh wurde dann im Arbeitsverzeichnis
